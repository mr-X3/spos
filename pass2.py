...
Problem Statement :- Implement Pass-II of two pass assembler for pseudo-machine in Python. The output of assignment-1 (intermediate file and symbol table) should be input for this assignment.
...
/**************************************************
Output :-
aditi@ubuntu:~/Desktop/SPOSA/a1$ python pass2.py
MOT Table
101 ['1', 2, 111]
102 ['2', 2, 112]
103 ['1', 3, 112]
